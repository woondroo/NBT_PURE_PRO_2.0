...
{    
    ...
    {
        return $this->whereHasType($field, CMongoDocument::FIELD_TYPE_DOUBLE);
    }
    
    public function whereString($field)
    {
        return $this->whereHasType($field, CMongoDocument::FIELD_TYPE_STRING);
    }
    
    public function whereObject($field)
    {
        return $this->whereHasType($field, CMongoDocument::FIELD_TYPE_OBJECT);
    }
    
    public function whereBoolean($field)
    {
        return $this->whereHasType($field, CMongoDocument::FIELD_TYPE_BOOLEAN);
    }
    ...
    {
        return $this->whereHasType($field, CMongoDocument::FIELD_TYPE_ARRAY);
    }
    
    public function whereObjectId($field)
    {
        return $this->whereHasType($field, CMongoDocument::FIELD_TYPE_OBJECT_ID);
    }
    
    public function whereDate($field)
    {
        return $this->whereHasType($field, CMongoDocument::FIELD_TYPE_DATE);
    }
    
    public function whereNull($field)
    {
        return $this->whereHasType($field, CMongoDocument::FIELD_TYPE_NULL);
    }
    ...
    public function whereElemMatch($field, CMongoExpression $expression)
    {
        return $this->where($field, array('$elemMatch' => $expression->toArray()));
    }
    
    public function whereElemNotMatch($field, CMongoExpression $expression)
    {
     ...
     * @param CMongoExpression $expression Instance of query
     * @param CMongoExpression $expression ...
     */
    public function whereOr($expressions = null)
    {
        if($expressions instanceof CMongoExpression) {
            $expressions = func_get_args();
        }
        
        return $this->where('$or', array_map(function(CMongoExpression $expression) {
    ...
    public function whereAnd($expressions = null)
    {
        ...
        return $this->where('$and', array_map(function(CMongoExpression $expression) {
            return $expression->toArray();
        }, $expressions));
    }
    ...
    public function whereNor($expressions = null)
    {
        ...
        return $this->where('$nor', array_map(function(CMongoExpression $expression) {
            return $expression->toArray();
        }, $expressions));
    }
    
    public function whereNot(CMongoExpression $expression)
    {
    ...
    public function merge(CMongoExpression $expression)
    {
