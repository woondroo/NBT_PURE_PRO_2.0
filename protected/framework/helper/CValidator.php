...
class CValidator
{
	...
	public static function cPhone( $_val = null , $_aryParams = array() , &$_message = "" )
	{
		$allowEmpty = isset( $_aryParams['allowEmpty'] ) ? $_aryParams['allowEmpty'] : false;		
		$pattern = "/^(0|86)?(13[0-9]|15[012356789]|18[0-9]|14[57])[0-9]{8}$/";
		$message = "";
	...
	public static function isEmpty( $_value,$_trim=false )
	{
		return $_value===null || $_value===array() || $_value==='' || $_trim && is_scalar($_value) && trim($_value)==='';
	}
	
	public static function cCaptcha( $_val = null , $_aryParams = array() , &$_message = "" )
	{
