...
class CUtil
{
	...
	{
		$aryData = array( self::SEX_MAN=>  CUtil::i18n('framework,cutil_gender_boy') , self::SEX_WOMEN=>  CUtil::i18n('framework,cutil_gender_girl') );
		if( is_null( $_intV ) )
			return $aryData;
		else
	...
	public function tranTime( $_timestamp ){
		$rtime = date("Y".CUtil::i18n('framework,cutil_time_year')."m"
                        .CUtil::i18n('framework,cutil_time_month')."d".CUtil::i18n('framework,cutil_time_day')
                        ." H:i:s", $_timestamp);
