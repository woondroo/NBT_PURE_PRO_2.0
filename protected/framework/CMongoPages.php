 ...
 *   $curPage = 当前页数;
 *
 *	 $pages = new CPages( $dataCount );
 *	 $pages->setActiveWay( 'JS' );
 *	 $pages->setCurrentPage( $curPage );
 *	 $pages->setPageSize( 5 );
 *	 $pages->setMaxButtonCount( 5 );
 *	 $pages->applyLimit( $criteria );
 */
class CMongoPages extends CComponents
{
	/**
	...
	public function getPageNav()
	{
		...
		if($this->header===null && false)
			$this->header="<label>".CUtil::i18n('framework,cpages_pageNav_di')
                        .($this->getCurrentPage()+1).CUtil::i18n('framework,cpages_pageNav_page')
                        ."&nbsp;|&nbsp;".CUtil::i18n('framework,cpages_pageNav_total')
                        .$this->getPageCount().CUtil::i18n('framework,cpages_pageNav_page')." </label>";
		*/
