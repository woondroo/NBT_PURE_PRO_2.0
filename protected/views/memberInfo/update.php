	...
	<div class="jumbotron">
		<form class="form-signin" role="form" method="POST" action="<?php echo $this->createUrl('memberInfo/updatePass');?>" id="updateForm" name="updateForm" onsubmit="return validateForm()">
			<div id="registDiv" class="validateDiv input-area">
				<?php echo CHtml::errorModelSummery( $model ); ?>
				<div class="input-group">
					<span class="input-group-addon glyphicon glyphicon-lock"></span>
					<input title="原始密码" placeholder="原始密码" class="form-control required" autocomplete="off" type="password" name="u_password" value="">
				</div>
				<div class="input-group">
					<span class="input-group-addon glyphicon glyphicon-lock"></span>
